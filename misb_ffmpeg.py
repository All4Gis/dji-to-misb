...
Only needs Python (standard library) and FFmpeg on the PATH.

Examples
--------
    python misb_ffmpeg.py --video ./sample/DJI_0047/DJI_0047.mp4 --csv ./sample/DJI_0047/telemetry.csv
    python misb_ffmpeg.py --video ./sample/DJI_0047/DJI_0047.mp4 --csv ./sample/DJI_0047/telemetry.csv --out MISB.ts
    python misb_ffmpeg.py --csv ./sample/DJI_0047/telemetry.csv --out MISB.ts --klv-only
    python misb_ffmpeg.py --video ./sample/DJI_0047/DJI_0047.mp4 --csv ./sample/DJI_0047/telemetry.csv --all-rows
...
# ===========================================================================
def mux_with_ffmpeg(video_path: str, packets, out_path: str) -> None:
...
def main(argv=None) -> int:
    ...
    # If --out is not given, derive it from the video name (+ "_MISB").
    if args.out is None:
        if not args.video:
    ...
    print("     Check it with:")
    print(f"       ffprobe {args.out}")
    print("     You should see a  'Data: klv (KLVA)'  stream besides video and audio.")
    return 0
